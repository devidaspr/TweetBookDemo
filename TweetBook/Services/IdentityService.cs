...
namespace TweetBook.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<AuthenticationResult> RefreshToeknAsync(string token, string refreshToken)
        {
            ...
            {
                return new AuthenticationResult { Errors = new[] { "This token hasn't yet expired" } };
            }
